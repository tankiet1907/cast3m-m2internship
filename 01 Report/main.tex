...
Concrete containment structures under severe-accident thermal loading present coupled thermo-hydro-mechanical challenges \cite{dauti_combined_2018}.
...
Heat transfer is the transport of thermal energy driven by a temperature difference. The following definitions of heat-transfer modes are summarized from standard references \cite{bergman_introduction_2017}.
...
Based on the principle of energy conservation and Fourier's law \cite{di_paola_starting_2023}, the general heat diffusion equation (or heat equation) for a medium can be expressed as:
...
Concrete cracks when tensile strains become too large. In this work, this behaviour is represented with the Mazars damage model \cite{hamon_model_2013}. 
...
High-strength concrete with $f_{c,28} = 77$ MPa is adopted, and 18 key parameters are selected for sensitivity analysis \cite{liu_stochastic_2001}.
...
This chapter follows the foundational framework of Baroth This chapter follows the foundational framework of Baroth \cite{baroth_introduction_2011}.
