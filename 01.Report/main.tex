...
\usepackage{setspace}
\usepackage{amsmath,amssymb,amsfonts,bm,siunitx}
\usepackage{booktabs}
\usepackage{pdfpages}
...
\includepdf[pages=-]{frontmatter/m2coverpage.pdf}
\thispagestyle{empty} % Blank page after title page w/out page number
%\input{frontmatter/titlepage} % Old title page without double frame
%\thispagestyle{empty} % Blank page after title page w/out page number
...
\setcounter{tocdepth}{1} % Set level to 2 levels (Chapter and Section)
\tableofcontents
