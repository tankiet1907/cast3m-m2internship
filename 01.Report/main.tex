...
% Bibliograpphy and Hyperref settings
...
% Highlight style for later review (line-breakable)
\usepackage{soul}
\sethlcolor{yellow}
...
% Thermal symbols
\nomenclature[T]{$T$}{Temperature [K]}
\nomenclature[T]{$q''$}{Heat flux [W\,m$^{-2}$]}
\nomenclature[T]{$\lambda$}{Thermal conductivity [W\,m$^{-1}$\,K$^{-1}$]}
\nomenclature[T]{$c_p$}{Specific heat capacity [J\,kg$^{-1}$\,K$^{-1}$]}
\nomenclature[T]{$\rho$}{Mass density [kg\,m$^{-3}$]}
\nomenclature[T]{$h$}{Convective heat transfer coefficient [W\,m$^{-2}$\,K$^{-1}$]}
\nomenclature[T]{$\sigma$}{Stefan--Boltzmann constant [W\,m$^{-2}$\,K$^{-4}$]}
\nomenclature[T]{$\varepsilon$}{Emissivity [-]}

% Hydraulic symbols
\nomenclature[H]{$p$}{Pore pressure [Pa]}
\nomenclature[H]{$k$}{Intrinsic permeability [m$^2$]}
...
\nomenclature[M]{$\boldsymbol{\sigma}$}{Cauchy stress tensor [Pa]}
\nomenclature[M]{$E$}{Young's modulus [Pa]}
\nomenclature[M]{$f_t$}{Tensile strength [Pa]}
\nomenclature[M]{$D$}{Damage variable [-]}
\nomenclature[M]{$G_f$}{Fracture energy [J\,m$^{-2}$]}
\nomenclature[M]{$L_e$}{Characteristic element length [m]}
