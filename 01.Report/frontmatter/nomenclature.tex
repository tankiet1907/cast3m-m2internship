...
\nomenclature[H]{$\boldsymbol{\varepsilon}_{rd}$}{Desiccation shrinkage strain related to drying \nomunit{-}}
\nomenclature[H]{$\boldsymbol{\varepsilon}_{re}$}{Endogenous shrinkage strain related to hydration \nomunit{-}}
...
\nomenclature[M]{$\mathbf{C}$}{Fourth-order isotropic elasticity tensor defined by $E$ and $\nu$ \nomunit{-}}
