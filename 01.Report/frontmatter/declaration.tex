...
In preparing this dissertation, the author used generative AI tools (Gemini and Claude) for limited technical assistance only: support with coding and debugging (\textsc{Cast3M}/Gibiane scripts and \textsc{Python} post-processing), language editing and structure suggestions, and help in quickly organising and synthesising data during the research process. The scientific content, the analyses, the interpretation of the results and the conclusions presented in this work were produced by the author.
