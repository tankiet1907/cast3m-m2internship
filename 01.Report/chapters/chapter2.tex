...
Due to the damage evolution, the stress-strain relationship becomes non-linear. The mechanical equilibrium \draft{cannot be solved in a single step like the elastic model. By introducing the non-linear complementary stress $\boldsymbol{\sigma}_{nl}$, the equilibrium} is rewritten as:
\begin{equation}
