...
\section{Thermo-Hydro-Mechanical (THM) coupling}

\subsection{Thermo-Hydric (TH) coupling mechanisms}
This section is currently under development and will be refined as the study progresses.

\subsection{Thermo-Mechanical (TM) coupling mechanisms}
This section is currently under development and will be refined as the study progresses.

\subsection{Full Thermo-Hydro-Mechanical (THM) governing formulation}
This section is currently under development and will be refined as the study progresses.


\section{Damage-dependent property evolution (THM-D)}
...
\subsection{Thermal properties evolution}

\begin{reviewblock}
It is worth noting that thermal properties such as the thermal conductivity ($\lambda$), the heat capacity ($c_p$), and the thermal expansion coefficient ($\alpha$) are assumed to depend mainly on temperature and moisture content. Their influence on the pore pressure evolution is relatively limited.

According to a global sensitivity analysis \cite{liu2001}, variations in thermal parameters account for only about 7\% of the total variance in pore pressure predictions. In contrast, the pore pressure development is highly sensitive to hygral parameters, particularly intrinsic permeability and dehydration laws, which together explain approximately 80\% of the total variance.

Therefore, although temperature-dependent $\lambda$, $c_p$, and $\alpha$ can be easily implemented in the finite element formulation (e.g., using temperature-dependent \texttt{EVOL} objects in Cast3M), their precise calibration is not critical. Accurate identification of permeability and dehydration parameters is significantly more important for reliable pore pressure prediction and spalling assessment.
