...
In the reliability context, the same model output $G$ (\cref{eq:hoeffding}) is reinterpreted as a \emph{limit-state function}. Each failure scenario is associated with a performance function (also called safety margin), denoted $G$ \cite{baroth2011}. By convention \cite{baroth2011,baroth2023}:
