...
\section{Stochastic finite element framework (Monte Carlo)}
...
\subsection{Random Field theory and Spatial variability}
...
\subsubsection{Discretized random field}
...
\subsection{Transformation of Lognormal to Gaussian distributionn}
...
\subsection{Integration of spatial variability into the THM model}
...
\section{Gaussian Quadrature framework}
...
\subsubsection{From integration to weighted sum}
\subsubsection{Orthogonal polynomials and weighting functions}
\subsubsection{Abscissas and weights construction}
...
\subsubsection{Mean, variance, skewness, kurtosis from quadrature}
\subsubsection{Variance decomposition per variable}
...
\subsubsection{Approximation methods (Pearson, Winterstein, Exp-Polynomial)}
\subsubsection{Probability of failure and reliability index}
...
\subsubsection{Monte Carlo: Sobol indices and Pearson correlation}
...
\subsection{Probability of failure from moment-based PDF}
This section is currently under development and will be refined as the study progresses.

\subsection{Probability of failure from Monte Carlo sampling}
This section is currently under development and will be refined as the study progresses.
