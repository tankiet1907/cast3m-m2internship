...
\begin{enumerate}
    ...
    \item \textbf{Gas pressure calibration and its limits:} The model matched the pressure in the outer layers ($10$ and $20~\mathrm{mm}$) but failed in deeper zones. This highlights the limits of both the current THC formulation and the experimental sensors themselves.
