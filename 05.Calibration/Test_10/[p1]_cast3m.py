...
# RECALIBRATION OF THE PERMEABILITY PARAMETERS (KINT, AK) - NEW VALUE OF VAPOR CONVECTION COEFFICTIENT H_ACC=0.001

# =========================================================
# ESTABLISHING PROJECT PATHWAYS
# =========================================================
working_dir = r"D:\cast3m-m2internship\05.Calibration\Test_10"
