...
time_sim = np.arange(0, 245, 5)  # Trục thời gian từ 0 đến 240 phút
...
csv_file = r'D:\cast3m-m2internship\02.Simulation\02.Results\CapillaryPressure_5min_Intervals.csv'
...
plt.xticks(np.arange(0, 241, 10), rotation=45)
